          ...
          <div class="row">
						<div class="col-md-12">
							 ...
							 <div class="box box-info">
								 ...
								 <!-- /.box-header -->
								 <!-- form start -->
								 <form class="form-horizontal" action="?page=svEk" method="post">
									 <div class="box-body">
										 <div class="form-group">
											 ...
											 <input type="hidden" name="kelas" value="<?php echo $c['id_kelas']; ?>">
												 <select class="form-control" name="siswa">
	 												...
	 												<?php
	 												$f = mysqli_query($connect, "SELECT DISTINCT * FROM siswa WHERE kelas = '$c[id_kelas];' AND NOT EXISTS (SELECT * FROM ekskul WHERE ekskul.id_siswa = siswa.nis)");
										 ...
										 <div class="form-group">
											 ...
											 <div class="col-sm-7">
												 <input type="text" class="form-control" name="nama_ekskul<?php echo $i?>" placeholder="Masukan Nama Ekstrakulikuler">
											 </div>
										 </div>
										 ...
										 <div class="form-group">
											 ...
											 <div class="col-sm-7">
												 <input type="text" class="form-control" name="nilai_ekskul<?php echo $i?>" placeholder="Masukan Nilai Ekstrakulikuler (A/B/C/D)">
											 </div>
										 </div>
										 <!-- Deskripsi sikap sosial -->
										 <div class="form-group">
											 ...
											 <div class="col-sm-7">
												 <input type="text" class="form-control" name="desk_ekskul<?php echo $i?>" placeholder="Masukan Deskripsi">
											 </div>
										 </div>
										 <?php
										   }
