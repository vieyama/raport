...
<?php
	...
	/*--------------------------------------------------------------------------*/
		...
		$acak           = rand(1,999999);
		$nama_file_unik = "Siswa-".$acak.$nama_file;
		...
		$ibu = antiinjection($_POST['nama_ibu']);
		$ibukerja = antiinjection($_POST['kerja_ibu']);
		$bapak = antiinjection($_POST['nama_bapak']);
		$bapakkerja = antiinjection($_POST['kerja_bapak']);
		...
		if (empty($lokasi_file)){
				...
				mysqli_query($connect, "UPDATE `pengguna` SET
									...
									mysqli_query($connect, "UPDATE `siswa` SET
										...
										`agama`='$agama',
										`nama_ibu`='$ibu',
										`pekerjaan_ibu`='$ibukerja',
										`nama_bapak`='$bapak',
										`pekerjaan_bapak`='$bapakkerja',
										`idu`='$no_induk',
										`kelas`='$kelas'
														WHERE idu = '$_POST[no_induk]'");
				...
				if(in_array($file_ext,$expensions)== false){
					...
					echo "<meta http-equiv='refresh' content='0;url=?page=edSv'>";
				}
