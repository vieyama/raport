	...
	<div class="col-xs-12">
		...
		<div class="col-md-12">
			<div class="box">
				...
				<form role="form" name="form1" action="?page=upProfSv" method="post" enctype="multipart/form-data" onSubmit="return validasi()">
					<div class="box-body">
													...
													<?php if($r['nama_ibu']==""){?>
														<p>
															<div class="form-group">
																...
																<br><i>Belum di Isi</i>
																<input type="text" class="form-control" name="nama_ibu" placeholder="Masukkan nama Bapak" value="<?php echo $r['nama_ibu']; ?>" required="required">
															</div>
														</p>
														<?php }else{?>
														<p>
