<?php
	...
	$ed = mysqli_query($connect, "SELECT * FROM guru, pengguna where guru.idu = pengguna.idu AND pengguna.idu = '$_GET[tid]'");
		...
		<div class="col-md-12">
			<div class="box">
				<div class="box-header with-border">
					<h3 class="box-title">Profil Guru <small>SMAN 3 Susukan</small></h3>
					<!-- tools box -->
				...
				<?php $sql = mysqli_query($connect, "select * from guru,pengguna where guru.idu = pengguna.idu and pengguna.username = '$_SESSION[username]'");
				...
				<div class="box-body">
					<p>
						<div class="form-group">
							...
							<input type="text" class="form-control" name="noreg" id="exampleInputNoReg1" placeholder="No. registrasi." value="<?php echo $r['nik']; ?>" disabled>
						</div>
					</p>
