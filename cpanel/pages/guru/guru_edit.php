	...
	<div class="row">
		...
		<div class="col-md-12">
			<div class="box">
				...
				<form role="form" name="form1" action="?page=upGr" method="post" enctype="multipart/form-data" onSubmit="return validasi()">
					<div class="box-body">
						...
						<p>
							<div class="form-group">
								...
								<input type="text" class="form-control" name="tempat_lahir" id="exampleInputPengguna1" placeholder="Masukkan Tempat Lahir" required="required">
							</div>
						</p>
						<?php }else{ ?>
						<p>
						...
						<?php if($r['tgl_lahir']=="0000-00-00"){ ?>
						<p>
							<div class="form-group">
								<label for="exampleInputPengguna1">Tanggal Lahir</label>
								<br><i>Tanggal Lahir Belum di Isi</i>
								<input type="text" name="tgl_lahir" class="form-control" id="datetimepicker2" placeholder="Pilih tanggal." required="required">
							</div>
						</p>
						<?php }else{?>
						<p>
