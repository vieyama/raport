<?php
	...
	$ed = mysqli_query($connect, "SELECT * FROM pengguna, admin  WHERE pengguna.idu = admin.idu AND pengguna.idu = '$_GET[tid]'");
					...
					<div class="box-body">
						...
						<p>
							<div class="form-group">
								...
								<input type="text" class="form-control" name="no_induk" id="exampleInputPasswd1" placeholder="Masukkan No Induk" value="<?php echo $r['id_admin']; ?>" required>
							</div>
						</p>
						...
						<p>
							<div class="form-group">
								...
								<input type="password" class="form-control" name="password" id="exampleInputPengguna1" placeholder="Masukkan Password" value="<?php echo $r['pass_asli']; ?>" required="required">
							</div>
						</p>
					...
					<?php }elseif($r['jenis_kelamin']=="Laki-laki"){?>
						...
						<p>
							<div class="form-group">
								...
								<p class="help-block">File foto harus bertipe *.jpeg, *.jpg, atau *.png dan memiliki size kurang dari 2 MB</p>
							</div>
						</p>
					</div>
