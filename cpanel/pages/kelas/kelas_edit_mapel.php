			...
			$ed = mysqli_query($connect,"SELECT * FROM kelas_guru, kelas, guru, semester, mapel WHERE kelas_guru.id_kelas = kelas.id_kelas AND kelas_guru.id_guru = guru.nik AND  kelas_guru.semester = semester.id_smt AND kelas_guru.id_mapel = mapel.id_mapel AND kelas_guru.id_kelas_guru = '$_GET[tid]'");
		    ...
		    <div class="col-md-12">
		      <div class="box">
		        <div class="box-header with-border">
		          <h3 class="box-title">Edit Mata Pelajaran di kelas ~ <?php echo $r['nama_kelas'] ?> ~</h3>
		        ...
		        <form role="form" name="form1" action="?page=upKlsv" method="post" enctype="multipart/form-data" onSubmit="return validasi()">
		          <div class="box-body">
		            ...
		            <p>
		              <div class="form-group">
		                <label for="exampleInputPengguna1">Nama Guru</label> <br> Guru saat ini : <?php echo $r['nama_guru']; ?>
		                  <select class="form-control" name="guru" required>
		                    <option>Belum diisi</option>
		                    <?php
		            ...
		            <p>
		              <div class="form-group">
		                <label for="exampleInputPengguna1">Semester</label>
										<br> Semester saat ini : <?php echo $r['smt']; ?>
		            ...
		            <p>
		              <div class="form-group">
		                <label for="exampleInputPengguna1">Mata Pelajaran</label>
										<br> Semester saat ini : <?php echo $r['nama_mapel']; ?>
